 ...
 *  Modification log:
 *
 *  14 May 91 RTP  Change Enumerated values for drivers to class into
 *                 groups
...
#define GKSARC      (Index) -1
#define GKSCHORD    (Index) -2
#define GKSPIE      (Index) -3
#define GKSCIRCLE   (Index) -4

#define SOFTWARE    (Index) -5
