...
void ATTline(int nb, Linebundle *lb, int nc, Lineatt *la) {
    ...
    else if (cur.vdc_type == REAL || cur.linewidth_mode == SCALED)
    ...
    else if (cur.color_mode == INDEXED)
...
void ATTmarker(int nb, Markerbundle *mb, int nc, Markeratt *ma) {
    ...
    else if (cur.vdc_type == REAL || cur.markersize_mode == SCALED)
...
void ATTedge(int nb, Edgebundle *eb, int nc, Edgeatt *ea) {
    ...
    else if (cur.vdc_type == REAL || cur.edgewidth_mode == SCALED)
