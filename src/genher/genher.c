...
int main(int argc, char **argv) {
    ...
    if (source == NULL) { /* Exit on the spot if open failed */
    ...
    do {
        ...
        if (finfile == NULL) {   /* Give up on this font if we cant open the finfile */
        ...
        if (binary == NULL) {   /***** Give up on this font if we cant open the binary */
